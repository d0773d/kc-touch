 ...
 * 
 * Adapted from esp-bsp display_camera_csi example for QR scanner use
 */
...
int app_video_open(char *dev, video_fmt_t init_fmt)
{
    ...
    ESP_LOGI(TAG, "width=%u height=%u", default_format.fmt.pix.width, default_format.fmt.pix.height);
