...
Status: Completed (baseline + smoke checklist documented in `docs/performance-baseline.md`)
...
Status: Completed for repository handoff (see `docs/release-checklist.md`)
